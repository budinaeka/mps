...
CREATE INDEX idx_pengobatan_tanggal ON pengobatan (tanggal);
...
CREATE INDEX idx_vaksinasi_type_tanggal ON vaksinasi (type, tanggal);
...
CREATE INDEX idx_monitoring_type ON monitoring (type);
...
CREATE INDEX idx_surveilans_tanggal ON surveilans (tanggal);
...
CREATE INDEX idx_surat_type_tanggal ON surat (type, tanggal);
...
CREATE UNIQUE INDEX uq_stok_obat_nama ON stok_obat (nama);
...
CREATE INDEX idx_pemakaian_tanggal ON pemakaian_obat (tanggal);
CREATE INDEX idx_pemakaian_obat_id ON pemakaian_obat (obat_id);
...
CREATE INDEX idx_kegiatan_lain_tanggal ON kegiatan_lain (tanggal);
...
CREATE INDEX idx_kunjungan_tamu_tanggal ON kunjungan_tamu (tanggal);
